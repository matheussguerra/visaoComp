...
% VC36O - thanks to james_tompkin@brown.edu for providing this code!
%
...
if strcmp(name,'code') || strcmp(name,'data') || strcmp(name,'questions') || strcmp(name,'writeup') || strcmp(name,'results')
...
zip( 'VC36Osubmission.zip', {'code/*.m','writeup/writeup.pdf','questions/questions.pdf','results/*.png'} );
